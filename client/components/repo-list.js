    ...
    <div>
      ...
      {filteredRepos.map((el) => (
        <div key={el.name} className="flex text-center">
          <div className="w-1/3 p-3 border-white rounded border-solid border mb-2 ml-2">{el.name}</div>
          <div className="w-1/3 p-3 border-white rounded border-solid border hover:bg-teal-400 duration-100 mb-2 ml-2">
